...
# Path to your LandSandBoat server directory
SERVER_BASE = os.path.expanduser("~/server")

# Path to your modules directory (where LQS and custom content lives)
LUA_BASE = os.path.join(SERVER_BASE, "modules/your_module/lua")
...
# Output paths (relative to this addon)
